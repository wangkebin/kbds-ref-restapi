...
func (fn DeletefilesHandlerFunc) Handle(params DeletefilesParams) middleware.Responder {
	return fn(params)
}
...
func NewDeletefiles(ctx *middleware.Context, handler DeletefilesHandler) *Deletefiles {
	return &Deletefiles{Context: ctx, Handler: handler}
}
...
func (o *Deletefiles) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewDeletefilesParams()
