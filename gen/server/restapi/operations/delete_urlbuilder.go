...
func (o *DeleteURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/delete/{fileid}"

	fileid := swag.FormatInt64(o.Fileid)
	if fileid != "" {
		_path = strings.Replace(_path, "{fileid}", fileid, -1)
	} else {
		return nil, errors.New("fileid is required on DeleteURL")
	}
